...
UI_SCHEMA = [
    ...
    ("Checks (on/off)", [("ENABLE_QUEUE", ""), ("ENABLE_PROVIDERS", ""), ("ENABLE_DECYPHARR", ""),
              ...
              ("ENABLE_BAZARR", ""), ("ENABLE_SEERR", ""), ("ENABLE_WARMER", ""),
              ("ENABLE_WESTREPAIR", ""), ("ENABLE_MISSING_SEASONS", ""),
              ("ENABLE_NO_UPGRADE_PROFILE", ""), ("NO_UPGRADE_PROFILE_ID", ""), ("NO_UPGRADE_PROFILE_NAME", "")]),
